...
import { FaFileAlt, FaChartBar, FaUserPlus, FaClipboardList } from 'react-icons/fa'
...
export default function UserDashboard() {
  ...
  const goTo = (k: keyof typeof typeLabel) => {
    router.push(`/dashboard/user/pengajuan?type=${encodeURIComponent(typeLabel[k])}`)
  }
  ...
  useEffect(() => {
    ...
    fetch('/api/document/summary-user-count', {
      method: 'POST',
          ...
          <div className="px-6 py-2">
            <div className="bg-white shadow rounded-md p-6 overflow-x-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-6">
                <div className="bg-cyan-600 text-white rounded-lg p-4 shadow-md hover:shadow-xl hover:scale-105 transform transition">
                ...
                <div className="bg-green-600 text-white rounded-lg p-4 shadow-md hover:shadow-xl hover:scale-105 transform transition">
                  <div className="flex justify-between items-center">
                ...
                <div className="bg-yellow-500 text-white rounded-lg p-4 shadow-md hover:shadow-xl hover:scale-105 transform transition">
                  <div className="flex justify-between items-center">
                ...
                <div className="bg-red-600 text-white rounded-lg p-4 shadow-md hover:shadow-xl hover:scale-105 transform transition">
                  <div className="flex justify-between items-center">
